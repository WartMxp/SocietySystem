...
namespace {
struct qt_meta_tag_ZN10AddStudentE_t {};
} // unnamed namespace

template <> constexpr inline auto AddStudent::qt_create_metaobjectdata<qt_meta_tag_ZN10AddStudentE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AddStudent, qt_meta_tag_ZN10AddStudentE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AddStudent::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10AddStudentE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10AddStudentE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10AddStudentE_t>.metaTypes,
    nullptr
} };
...
void *AddStudent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10AddStudentE_t>.strings))
