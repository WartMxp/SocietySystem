...
template <> constexpr inline auto Widget::qt_create_metaobjectdata<qt_meta_tag_ZN6WidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "delayedLoad",
        "",
        "on_testButtom_clicked",
        "on_usersname_linkActivated",
        "link",
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_testButtom_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_usersname_linkActivated'
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->delayedLoad(); break;
        case 1: _t->on_testButtom_clicked(); break;
        case 2: _t->on_usersname_linkActivated((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Widget::*)()>(_a, &Widget::delayedLoad, 0))
            return;
    }
}
